...
AWS_S3_MAX_MEMORY_SIZE = 5 * 1024 * 1024  # 5MB in-memory buffer
AWS_S3_USE_THREADS = False  # Disable threading for better error visibility
AWS_LOCATION = 'media'  # Force consistent path
...
# For existing media/ path compatibility
...
def verify_s3_config():
    ...
    if missing:
        raise ImproperlyConfigured(
            f"Missing S3 settings: {', '.join(missing)}"
        )
